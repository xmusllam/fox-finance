...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 pb-24 pt-[100px] md:pt-28" dir="rtl">
      ...
      {/* Main Content */}
      <div className="container mx-auto px-4 py-6 mt-4 md:mt-0">
        {activeTab === 'dashboard' && (
          <Dashboard 
            userId={user.uid} 
